        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-auto">
            ...
            <div className="p-8">
              ...
              <div id="resume-preview-content" className="bg-gray-50 border-2 border-gray-200 rounded-xl p-8 min-h-[800px]">
                      ...
                      exp.title && (
                        <div key={idx} className="mb-4">
                          <div className="job-header">
                            ...
                            <span className="text-sm text-gray-600 date">
                              {exp.startDate} - {exp.current ? 'Present' : exp.endDate}
                            </span>
                          </div>
                          <div className="text-gray-700 mb-2 company">
                            {exp.company} {exp.location && `• ${exp.location}`}
                          </div>
                          {exp.description && (
                            <p className="text-gray-600 text-sm description">{exp.description}</p>
                          )}
                        </div>
                      )
                    ))}
                      ...
                      edu.degree && (
                        <div key={idx} className="mb-4">
                          <div className="job-header">
                            ...
                            <span className="text-sm text-gray-600 date">{edu.graduationDate}</span>
                          </div>
                          <div className="text-gray-700 company">
                    ...
                    {formData.projects.map((proj, idx) => (
                      proj.name && (
                        <div key={idx} className="mb-4">
                          ...
                          {proj.technologies && (
                            <div className="text-sm text-blue-600 mb-1 tech-stack">{proj.technologies}</div>
                          )}
                          {proj.description && (
                            <p className="text-gray-600 text-sm description">{proj.description}</p>
                          )}
                        </div>
                      )
                    ))}
